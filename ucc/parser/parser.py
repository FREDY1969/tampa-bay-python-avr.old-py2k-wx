...
def p_file_0001(p):
    ...
    args = []
    args.append(p[1])
    p[0] = ast.ast(p, kind='word_body', *args)
...
def p_expr_0001(p):
    ...
    '''
    args = []
    p[0] = ast.ast(p, kind='approx', int1=p[1][0], int2=p[1][1], *args)

def p_expr_0002(p):
    r''' expr : CHAR
    '''
    args = []
    p[0] = ast.ast(p, kind='int', int1=p[1], *args)
...
def p_expr_0004(p):
    ...
    '''
    args = []
    p[0] = ast.ast(p, kind='ratio', int1=p[1][0], int2=p[1][1], *args)

def p_expr_0005(p):
    r''' expr : STRING
    '''
    args = []
    p[0] = ast.ast(p, kind='string', str=p[1], *args)
