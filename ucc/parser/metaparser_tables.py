...
_lr_productions = [
  ...
  ('word -> sub_rule ?','word',2,'p_opt_word','ucc/parser/metaparser.py',188),
  ('word -> sub_rule +','word',2,'p_one_or_more_word','ucc/parser/metaparser.py',221),
  ('word -> sub_rule *','word',2,'p_zero_or_more_word','ucc/parser/metaparser.py',262),
  ('word -> sub_rule ELLIPSIS','word',2,'p_word_ellipsis','ucc/parser/metaparser.py',295),
  ('parameterized_word -> simple_word param_list','parameterized_word',2,'p_parameterized_word','ucc/parser/metaparser.py',326),
  ('sub_rule -> simple_word AS_TOK NONTERMINAL','sub_rule',3,'p_sub_rule','ucc/parser/metaparser.py',336),
  ('sub_rule -> { alternatives }','sub_rule',3,'p_sub_rule2','ucc/parser/metaparser.py',348),
  ('simple_word -> TOKEN_IGNORE','simple_word',1,'p_token_ignore','ucc/parser/metaparser.py',355),
  ('simple_word -> CHAR_TOKEN','simple_word',1,'p_char_token','ucc/parser/metaparser.py',362),
  ('simple_word -> TOKEN','simple_word',1,'p_token','ucc/parser/metaparser.py',367),
  ('simple_word -> NONTERMINAL','simple_word',1,'p_nonterminal','ucc/parser/metaparser.py',374),
  ('simple_word -> TUPLE_NONTERMINAL','simple_word',1,'p_tuple_simple_word','ucc/parser/metaparser.py',379),
  ('param_list -> ( parameters_opt )','param_list',3,'p_param_list','ucc/parser/metaparser.py',384),
  ('parameters_opt -> <empty>','parameters_opt',0,'p_no_parameters_opt','ucc/parser/metaparser.py',389),
  ('parameters -> parameter','parameters',1,'p_parameters1','ucc/parser/metaparser.py',394),
  ('parameters -> parameters , parameter','parameters',3,'p_parametersn','ucc/parser/metaparser.py',399),
  ('parameter -> NONTERMINAL PYTHON_CODE','parameter',2,'p_parameter','ucc/parser/metaparser.py',404),
]
